...
class BookMark {
  ...
  addBookMark(pageNumber) {
    pageNumber > this.totalPages || pageNumber < 1 || this.bookMarks.some(item => item === pageNumber) ? null : this.bookMarks.push(pageNumber)
  ...
  goToLastBookMark = () => this.bookMarks[this.bookMarks.length - 1] || undefined;
